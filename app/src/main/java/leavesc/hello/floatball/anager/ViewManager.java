...
//    private FloatBall floatBall;
    ...
    private void init() {
        ...
        floatBall = LayoutInflater.from(context).inflate(R.layout.layout_system_dialog, null);
        content = floatBall.findViewById(R.id.content);
...
//                        floatBall.setDragState(true);
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (endX < getScreenWidth() / 2) {
                            ...
                            endX = getScreenWidth() - floatBall.getMeasuredWidth();
                        }
...
//        floatBall.setOnClickListener(clickListener);
    ...
    public void showFloatBall() {
        if (floatBallParams == null) {
            ...
            floatBallParams.width = getScreenWidth();
            floatBallParams.height = 200 - getStatusHeight();
